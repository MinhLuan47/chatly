...
const formSignUpSchema = z.object({
    firstName: z.string().min(3, 'Họ phải có ít nhất 3 ký tự'),
    lastName: z.string().min(1, 'Tên phải có ít nhất 1 ký tự'),
    email: z.email(),
    username: z.string().min(3, 'Tên đăng nhập phải có ít nhất 3 ký tự'),
    password: z.string().min(6, 'Mật khẩu phải có ít nhất 6 ký tự'),
});

type FormSignUp = z.infer<typeof formSignUpSchema>;
                    ...
                    <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
                        <FieldGroup>
                            <div className="flex flex-col items-center gap-2 text-center">
                                <h1 className="text-2xl font-bold">Tạo tài khoản Chatly</h1>
